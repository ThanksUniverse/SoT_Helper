...
//        {
//            //string namespaceSuffix = "SoT_Helper.";
...
//                {
//                    string resourceName = namespaceSuffix+name + ".hlsl.bytes";
//                    var filepath = allfiles.Where(f => f.Contains(resourceName)).FirstOrDefault();
//                    if (filepath != null)
//                    {
...
//                {
//                    string resourceName = namespaceSuffix + name + ".glsl";
//                    var filepath = allfiles.Where(f => f.Contains(resourceName)).FirstOrDefault();
//                    if (filepath != null)
//                    {
//                        return File.ReadAllBytes(filepath);
...
//                {
//                    string resourceName = namespaceSuffix + name + ".spv";
//                    var filepath = allfiles.Where(f => f.Contains(resourceName)).FirstOrDefault();
//                    if (filepath != null)
//                    {
//                        return File.ReadAllBytes(filepath);
...
//                {
//                    string resourceName = namespaceSuffix + name + ".metallib";
//                    var filepath = allfiles.Where(f => f.Contains(resourceName)).FirstOrDefault();
//                    if (filepath != null)
//                    {
//                        return File.ReadAllBytes(filepath);
